...
depsHostHost=''
export depsHostHost
nativeBuildInputs='/nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev /nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env /nix/store/zm1r41552j7zkys0zdgrssnj7ahsdpmq-pyright-1.1.408 /nix/store/qm9y4fm5ff6sqr9wbpksjfh0d3hcjyl7-main /nix/store/9d4a2i6h1n6km9yxdjm7g7x3dx2p02yb-python3.13-paramiko-4.0.0 /nix/store/fpxg55v9x802bxnvdm9yfg63shfanm6m-python3.13-pyqt6-6.9.0-dev /nix/store/p9r5svlyc62k8nivhr7zi9kcc8735zyh-mutagen-0.18.0 /nix/store/1nv3i8mpypy3d516f4pd95m0w72r73jy-pkg-config-wrapper-0.29.2'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/hlxw2q9qansq7bn52xvlb5badw3z1v8s-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/5pb91d95jhl5y9kw8cz4ihsl1ff9rs6i-devenv-profile" ]
then
  ln -snf /nix/store/5pb91d95jhl5y9kw8cz4ihsl1ff9rs6i-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /run/user/1000/devenv-5a82385
ln -snf /run/user/1000/devenv-5a82385 /home/nandi/code/syncer/.devenv/run


export PYTHONPATH="$DEVENV_PROFILE/lib/python3.13/site-packages${PYTHONPATH:+:$PYTHONPATH}"



# Check whether the direnv integration is out of date.
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/nandi/code/syncer:"* ]]; then
...
OBJDUMP='objdump'
export OBJDUMP
DEVENV_TASK_FILE='/nix/store/q3f41h3lp4i3yqpzd5d18vchkr1vnmwf-tasks.json'
export DEVENV_TASK_FILE
HOSTTYPE='x86_64'
PYTHONHASHSEED='0'
export PYTHONHASHSEED
out='/nix/store/ncnc17szzgc5qpib6jc2am34xh67nmhi-devenv-shell-env'
export out
DEVENV_ROOT='/home/nandi/code/syncer'
export DEVENV_ROOT
IFS=' 	
'
...
PS4='+ '
outputInclude='out'
prefix='/nix/store/ncnc17szzgc5qpib6jc2am34xh67nmhi-devenv-shell-env'
...
export name
NIX_CFLAGS_COMPILE=' -frandom-seed=ncnc17szzg -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env/include -isystem /nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/include -isystem /nix/store/7v22wznipq4m6jl03n9y5s514fd80nan-python3.13-dbus-python-1.4.0-dev/include -isystem /nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/include -isystem /nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env/include -isystem /nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/include -isystem /nix/store/7v22wznipq4m6jl03n9y5s514fd80nan-python3.13-dbus-python-1.4.0-dev/include'
...
DEVENV_DOTFILE='/home/nandi/code/syncer/.devenv'
...
PKG_CONFIG_PATH='/nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev/lib/pkgconfig:/nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env/lib/pkgconfig:/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/lib/pkgconfig:/nix/store/7v22wznipq4m6jl03n9y5s514fd80nan-python3.13-dbus-python-1.4.0-dev/lib/pkgconfig'
export PKG_CONFIG_PATH
declare -a propagatedHostDepFiles=('propagated-host-host-deps' 'propagated-build-inputs' )
DEVENV_STATE='/home/nandi/code/syncer/.devenv/state'
export DEVENV_STATE
CXX='g++'
export CXX
...
phases='buildPhase'
export phases
DEVENV_RUNTIME='/run/user/1000/devenv-5a82385'
...
export builder
PYTHONPATH='/nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env/lib/python3.13/site-packages:/nix/store/9d4a2i6h1n6km9yxdjm7g7x3dx2p02yb-python3.13-paramiko-4.0.0/lib/python3.13/site-packages:/nix/store/y6m6x9ax6aj119q1lq88b5ddnwq2iq75-python3.13-bcrypt-5.0.0/lib/python3.13/site-packages:/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/lib/python3.13/site-packages:/nix/store/4jh36f5z8yhk8vz2zv54b761bynj77mx-python3.13-cryptography-46.0.4/lib/python3.13/site-packages:/nix/store/w7hyxgvvq38bdx5jv9rq9gpk1zynzd8b-python3.13-cffi-2.0.0/lib/python3.13/site-packages:/nix/store/kd0yrsmrslihfp66y2k88cyan1vjydl8-python3.13-pycparser-3.00/lib/python3.13/site-packages:/nix/store/2knqig9rff4b68h2lih1pmlb2mkkjsg9-python3.13-pynacl-1.6.2/lib/python3.13/site-packages:/nix/store/7al5d14pv3vzrnyg3cbidphqc5c28f34-python3.13-pyqt6-sip-13.10.2/lib/python3.13/site-packages:/nix/store/01v6bjnvi67p8pa4xjn5yfr1sv9g3yzc-python3.13-dbus-python-1.4.0/lib/python3.13/site-packages:/nix/store/9q4s5rq0jbq07qq3cwwkvhsgy21l88d3-python3.13-pyqt6-6.9.0/lib/python3.13/site-packages'
export PYTHONPATH
DEVENV_PROFILE='/nix/store/5pb91d95jhl5y9kw8cz4ihsl1ff9rs6i-devenv-profile'
...
declare -a pkgsBuildHost=('/nix/store/pg04l21ca5xaif9hplyi09lhqxbipkcx-bash-interactive-5.3p9-dev' '/nix/store/0550j0i8bmzxbcnzrg1g51zigj7y12ih-bash-interactive-5.3p9' '/nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env' '/nix/store/zm1r41552j7zkys0zdgrssnj7ahsdpmq-pyright-1.1.408' '/nix/store/qm9y4fm5ff6sqr9wbpksjfh0d3hcjyl7-main' '/nix/store/9d4a2i6h1n6km9yxdjm7g7x3dx2p02yb-python3.13-paramiko-4.0.0' '/nix/store/y6m6x9ax6aj119q1lq88b5ddnwq2iq75-python3.13-bcrypt-5.0.0' '/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12' '/nix/store/4jh36f5z8yhk8vz2zv54b761bynj77mx-python3.13-cryptography-46.0.4' '/nix/store/w7hyxgvvq38bdx5jv9rq9gpk1zynzd8b-python3.13-cffi-2.0.0' '/nix/store/kd0yrsmrslihfp66y2k88cyan1vjydl8-python3.13-pycparser-3.00' '/nix/store/2knqig9rff4b68h2lih1pmlb2mkkjsg9-python3.13-pynacl-1.6.2' '/nix/store/fpxg55v9x802bxnvdm9yfg63shfanm6m-python3.13-pyqt6-6.9.0-dev' '/nix/store/7al5d14pv3vzrnyg3cbidphqc5c28f34-python3.13-pyqt6-sip-13.10.2' '/nix/store/7v22wznipq4m6jl03n9y5s514fd80nan-python3.13-dbus-python-1.4.0-dev' '/nix/store/01v6bjnvi67p8pa4xjn5yfr1sv9g3yzc-python3.13-dbus-python-1.4.0' '/nix/store/9q4s5rq0jbq07qq3cwwkvhsgy21l88d3-python3.13-pyqt6-6.9.0' '/nix/store/p9r5svlyc62k8nivhr7zi9kcc8735zyh-mutagen-0.18.0' '/nix/store/1nv3i8mpypy3d516f4pd95m0w72r73jy-pkg-config-wrapper-0.29.2' '/nix/store/590yx3aynyhs48jyk8ip37fk1mjqfhkb-patchelf-0.15.2' '/nix/store/gz3rknshr1ywis4mjaqrgj3z2shp3n3v-update-autotools-gnu-config-scripts-hook' '/nix/store/0y5xmdb7qfvimjwbq7ibg1xdgkgjwqng-no-broken-symlinks.sh' '/nix/store/cv1d7p48379km6a85h4zp6kr86brh32q-audit-tmpdir.sh' '/nix/store/85clx3b0xkdf58jn161iy80y5223ilbi-compress-man-pages.sh' '/nix/store/p3l1a5y7nllfyrjn2krlwgcc3z0cd3fq-make-symlinks-relative.sh' '/nix/store/5yzw0vhkyszf2d179m0qfkgxmp5wjjx4-move-docs.sh' '/nix/store/fyaryjvghbkpfnsyw97hb3lyb37s1pd6-move-lib64.sh' '/nix/store/kd4xwxjpjxi71jkm6ka0np72if9rm3y0-move-sbin.sh' '/nix/store/pag6l61paj1dc9sv15l7bm5c17xn5kyk-move-systemd-user-units.sh' '/nix/store/cmzya9irvxzlkh7lfy6i82gbp0saxqj3-multiple-outputs.sh' '/nix/store/x8c40nfigps493a07sdr2pm5s9j1cdc0-patch-shebangs.sh' '/nix/store/cickvswrvann041nqxb0rxilc46svw1n-prune-libtool-files.sh' '/nix/store/xyff06pkhki3qy1ls77w10s0v79c9il0-reproducible-builds.sh' '/nix/store/z7k98578dfzi6l3hsvbivzm7hfqlk0zc-set-source-date-epoch-to-latest.sh' '/nix/store/pilsssjjdxvdphlg2h19p0bfx5q0jzkn-strip.sh' '/nix/store/kbw2j1vag664b3sj3rjwz9v53cqx87sb-gcc-wrapper-15.2.0' '/nix/store/4yi6jj75bb5hhdzpzlxfyf69d35wsf2x-binutils-wrapper-2.44' )
mesonFlags=''
export mesonFlags
OBJCOPY='objcopy'
export OBJCOPY
...
outputs='out'
export outputs
NIX_LDFLAGS='-rpath /nix/store/ncnc17szzgc5qpib6jc2am34xh67nmhi-devenv-shell-env/lib  -L/nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env/lib -L/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/lib -L/nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env/lib -L/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/lib'
export NIX_LDFLAGS
...
outputDev='out'
XDG_DATA_DIRS='/nix/store/0550j0i8bmzxbcnzrg1g51zigj7y12ih-bash-interactive-5.3p9/share:/nix/store/yjpzlvyn6d5zjlxn7gqsa70bli1gsi2d-python3-3.13.12-env/share:/nix/store/m1fw8l8y9ycxh5dzispbb7cwl6rra14l-python3-3.13.12/share:/nix/store/p9r5svlyc62k8nivhr7zi9kcc8735zyh-mutagen-0.18.0/share:/nix/store/1nv3i8mpypy3d516f4pd95m0w72r73jy-pkg-config-wrapper-0.29.2/share:/nix/store/590yx3aynyhs48jyk8ip37fk1mjqfhkb-patchelf-0.15.2/share'
...
exec /tmp/devenv-env6PgRxf/script 